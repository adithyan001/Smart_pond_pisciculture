...
const int tp=4000; //filling water from pond
const int tb=10000; //spraying base
const int ta=10000; //spraying acid
const int tout=6000; //empty container
const int td=4000; //filling distilled water
...
{ 
  ...
  display.showNumberDec(seg7_ph,true);
